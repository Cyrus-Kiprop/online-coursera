...
export default function configureStore(initialState) {
  ...
  return createStore(
    rootReducer,
    initialState,
    composeEnhancers(applyMiddleware(thunk, reduxImmutableStateInvariant())) // this crazy middleware will actually warns whenever we try to mutate our state(saftey net)
  );
}
